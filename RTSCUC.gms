...
*-----------------------05/31/2023----------------------------------------------
UNIT_RAMP_UP_OFF_ENFORCED(GEN,INTERVAL)
...
*------------------05/31/2023---------------------------------------------------
$load UNIT_RAMP_UP_OFF_ENFORCED
...
Q_THERMAL_LOAD_BALANCE(INTERVAL)
...
*--------------------------05/31/2023-------------------------------------------
Q_RAMP_UP_OFF_INITIAL(GEN,INTERVAL)
Q_CONSECUTIVE_RAMP_UP_DN(GEN,INTERVAL)
****************************************
Q_RESERVE_CAPABILITY_SMR(GEN,INTERVAL,RESERVETYPE)
Q_RESERVE_RAMPUP_LIMIT_SMR(GEN,INTERVAL)
Q_RESERVE_RAMPDOWN_LIMIT_SMR(GEN,INTERVAL)
;
...
*DH_LOAD(INTERVAL)/1.5=E=(3/4)*GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL)*100+DH_LOSS_LOAD(INTERVAL)
$onText
Q_THERMAL_LOAD_BALANCE(INTERVAL)..
DH_LOAD(INTERVAL)*1.5=L=(2/3)*SUM(NUCLEAR_GEN,GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL))*100+DH_LOSS_LOAD(INTERVAL)
;
$offText

Q_THERMAL_LOAD_BALANCE(INTERVAL)..
DH_LOAD(INTERVAL)=L=(2/3)*SUM(NUCLEAR_GEN,GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL))*100+DH_LOSS_LOAD(INTERVAL)
;
...
;
*-----------------------05/31/2023----------------------------------------------
Q_RAMP_UP_OFF_INITIAL(NUCLEAR_GEN,INTERVAL)..
NUCLEAR_RAMP_UP(NUCLEAR_GEN,INTERVAL) =l= UNIT_RAMP_UP_OFF_ENFORCED(NUCLEAR_GEN,INTERVAL)
;
...
PRODCOST_BY_INTERVAL(INTERVAL) =E=
                         ...
                         +SUM(ACTIVE_GEN, SUM(RESERVETYPE,GEN_RESERVE_SCHEDULE(ACTIVE_GEN,INTERVAL,RESERVETYPE)*RESERVE_COST(ACTIVE_GEN,RESERVETYPE)*INTERVAL_LENGTH*SYSTEMVALUE("MVA_PERUNIT"))
                )+
                         SUM(HES_GEN,
                ...
                ) + DH_LOSS_LOAD(INTERVAL)*4000*INTERVAL_LENGTH
...
(GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL)-LAST_GEN_SCHEDULE(NUCLEAR_GEN))=l=(1-NUCLEAR_STABLE(NUCLEAR_GEN,INTERVAL))*GENVALUE(NUCLEAR_GEN,"RAMP_RATE")*60*INTERVAL_LENGTH
;
********************************************************************************
********************************************************************************

Q_INITIAL_NUCLEAR_SCHEDULE_DN(NUCLEAR_GEN,INTERVAL)$(ORD(INTERVAL) EQ  1 )..
(GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL)-LAST_GEN_SCHEDULE(NUCLEAR_GEN))=G=-1*(1-NUCLEAR_STABLE(NUCLEAR_GEN,INTERVAL))*GENVALUE(NUCLEAR_GEN,"RAMP_RATE")*60*INTERVAL_LENGTH
...
LAST_GEN_SCHEDULE(NUCLEAR_GEN)-GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL)=l= GENVALUE(NUCLEAR_GEN,"RAMP_RATE")*60*INTERVAL_LENGTH*NUCLEAR_RAMP_DN(NUCLEAR_GEN,INTERVAL)- .0001*NUCLEAR_RAMP_UP(NUCLEAR_GEN,INTERVAL)

;
Q_NUCLEAR_RAMPUP_INITIAL(NUCLEAR_GEN,INTERVAL)$(ORD(INTERVAL) EQ 1)..
GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL)-LAST_GEN_SCHEDULE(NUCLEAR_GEN)=l= GENVALUE(NUCLEAR_GEN,"RAMP_RATE")*60*INTERVAL_LENGTH*NUCLEAR_RAMP_UP(NUCLEAR_GEN,INTERVAL)- .0001*NUCLEAR_RAMP_DN(NUCLEAR_GEN,INTERVAL)
...
;
Q_CONSECUTIVE_RAMP_UP_DN(NUCLEAR_GEN,INTERVAL)$(ORD(INTERVAL) LT (CARD(INTERVAL)- ((1/INTERVAL_LENGTH)*GENVALUE(NUCLEAR_GEN,"HOLD_TIME"))) )..
NUCLEAR_RAMP_DN(NUCLEAR_GEN,INTERVAL)+SUM(H$ ( ( ORD(H) GT ORD(INTERVAL)) AND(ORD(H) LT (ORD(INTERVAL)+((1/INTERVAL_LENGTH)*GENVALUE(NUCLEAR_GEN,"HOLD_TIME")))) ),NUCLEAR_RAMP_UP(NUCLEAR_GEN,H) )=l=1;
************** New reserve design included on July 28, 2023********
Q_RESERVE_CAPABILITY_SMR(NUCLEAR_GEN,INTERVAL,RESERVETYPE)..
GEN_RESERVE_SCHEDULE(NUCLEAR_GEN,INTERVAL,RESERVETYPE) =L=
         (1-NUCLEAR_STABLE(NUCLEAR_GEN,INTERVAL))*RESERVEVALUE(RESERVETYPE,"RESERVE_ON")*GENVALUE(NUCLEAR_GEN,"RAMP_RATE")*RESERVEVALUE(RESERVETYPE,"RESERVE_TIME")
*             RESERVEVALUE(RESERVETYPE,"RESERVE_AGC")*GENVALUE(NUCLEAR_GEN,"AGC_QUALIFIED")
*         + (UNIT_STATUS(NUCLEAR_GEN,INTERVAL) + PUMPING(NUCLEAR_GEN,INTERVAL))*RESERVEVALUE(RESERVETYPE,"RESERVE_ON")*GENVALUE(NUCLEAR_GEN,"RAMP_RATE")*RESERVEVALUE(RESERVETYPE,"RESERVE_TIME")*
*                 (1-RESERVEVALUE(RESERVETYPE,"RESERVE_AGC"))
*         + (1 - UNIT_STATUS(NUCLEAR_GEN,INTERVAL) - PUMPING(NUCLEAR_GEN,INTERVAL)) * (1 - RESERVEVALUE(RESERVETYPE,"RESERVE_ON")) * QSC(NUCLEAR_GEN,RESERVETYPE)
;

Q_RESERVE_RAMPUP_LIMIT_SMR(NUCLEAR_GEN,INTERVAL)..
SUM(RESERVETYPE$(RESERVEVALUE(RESERVETYPE,"RESERVE_ON") EQ 1 AND (RESERVEVALUE(RESERVETYPE,"RESERVE_DIR") EQ 1 OR RESERVEVALUE(RESERVETYPE,"RESERVE_DIR") EQ 3)),
         GEN_RESERVE_SCHEDULE(NUCLEAR_GEN,INTERVAL,RESERVETYPE)/RESERVEVALUE(RESERVETYPE,"RESERVE_TIME"))
         =L= NUCLEAR_RAMP_UP(NUCLEAR_GEN,INTERVAL)*GENVALUE(NUCLEAR_GEN,"RAMP_RATE")
*+(1-NUCLEAR_RAMP_DN(NUCLEAR_GEN,INTERVAL))*GENVALUE(NUCLEAR_GEN,"RAMP_RATE")
;

Q_RESERVE_RAMPDOWN_LIMIT_SMR(NUCLEAR_GEN,INTERVAL)..
SUM(RESERVETYPE$(RESERVEVALUE(RESERVETYPE,"RESERVE_ON") EQ 1 AND (RESERVEVALUE(RESERVETYPE,"RESERVE_DIR") EQ 2 OR RESERVEVALUE(RESERVETYPE,"RESERVE_DIR") EQ 3)),
         GEN_RESERVE_SCHEDULE(NUCLEAR_GEN,INTERVAL,RESERVETYPE)/RESERVEVALUE(RESERVETYPE,"RESERVE_TIME"))
         =L= (1-NUCLEAR_RAMP_UP(NUCLEAR_GEN,INTERVAL))*GENVALUE(NUCLEAR_GEN,"RAMP_RATE")
;
...
*-------------------------------------------------------------------------------
*Q_UNIVERSAL_NUCLEAR_SCHEDULE_UP
Q_INITIAL_NUCLEAR_SCHEDULE_UP
********************************************************************************
*Q_UNIVERSAL_NUCLEAR_SCHEDULE_DN
Q_INITIAL_NUCLEAR_SCHEDULE_DN
**10/10/2022
Q_NUCLEAR_RAMPDOWN_INITIAL
Q_NUCLEAR_RAMPUP_INITIAL
*--------------------------------05/31/2023-------------------------------------
Q_RAMP_UP_OFF_INITIAL
Q_CONSECUTIVE_RAMP_UP_DN
********************************
Q_RESERVE_CAPABILITY_SMR
Q_RESERVE_RAMPUP_LIMIT_SMR
Q_RESERVE_RAMPDOWN_LIMIT_SMR
/;
