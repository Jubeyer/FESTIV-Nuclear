...
Q_NUCLEAR_RAMP_STABLE4(GEN,INTERVAL)
*$offText
*************************************01/20/2023**********************
...
PRODCOST_BY_INTERVAL(INTERVAL) =E=
                 ...
                 +  (INTERVAL_MINUTES(INTERVAL)/60)*(DH_LOSS_LOAD(INTERVAL))*4000+
                 SUM(RESERVETYPE,
...
Q_NUCLEAR_RAMP_STABLE4(NUCLEAR_GEN,INTERVAL)$( (ORD(INTERVAL) LT CARD(INTERVAL)) AND ( NUCLEAR_STABLE(NUCLEAR_GEN,INTERVAL) EQ 1) AND (NUCLEAR_STABLE(NUCLEAR_GEN,INTERVAL+1) EQ 1) )..
GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL)-GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL+1)=E=0;
********************************************************************************01/20/2023***************************************************************************
...
LAST_GEN_SCHEDULE(NUCLEAR_GEN)-GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL)=l= GENVALUE(NUCLEAR_GEN,"RAMP_RATE")*60*INTERVAL_LENGTH*NUCLEAR_RAMP_DN(NUCLEAR_GEN,INTERVAL)
*GENVALUE(NUCLEAR_GEN,"INITIAL_MW")-GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL)=l= GENVALUE(NUCLEAR_GEN,"RAMP_RATE")*60*INTERVAL_LENGTH*NUCLEAR_RAMP_DN(NUCLEAR_GEN,INTERVAL)
*- .0001*NUCLEAR_RAMP_UP(NUCLEAR_GEN,INTERVAL)
;
Q_NUCLEAR_RAMPUP_INITIAL(NUCLEAR_GEN,INTERVAL)$(ORD(INTERVAL) EQ 1)..
GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL)-LAST_GEN_SCHEDULE(NUCLEAR_GEN)=l= GENVALUE(NUCLEAR_GEN,"RAMP_RATE")*60*INTERVAL_LENGTH*NUCLEAR_RAMP_UP(NUCLEAR_GEN,INTERVAL)
*GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL)-GENVALUE(NUCLEAR_GEN,"INITIAL_MW")=l= GENVALUE(NUCLEAR_GEN,"RAMP_RATE")*60*INTERVAL_LENGTH*NUCLEAR_RAMP_UP(NUCLEAR_GEN,INTERVAL)
*- .0001*NUCLEAR_RAMP_DN(NUCLEAR_GEN,INTERVAL)
;

Q_NUCLEAR_RAMPDOWN(NUCLEAR_GEN,INTERVAL)$(ORD(INTERVAL) GT 1)..
GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL-1)-GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL)=l= GENVALUE(NUCLEAR_GEN,"RAMP_RATE")*60*INTERVAL_LENGTH*NUCLEAR_RAMP_DN(NUCLEAR_GEN,INTERVAL)
*- .0001*NUCLEAR_RAMP_UP(NUCLEAR_GEN,INTERVAL)
;
Q_NUCLEAR_RAMPUP(NUCLEAR_GEN,INTERVAL)$(ORD(INTERVAL) GT 1)..
GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL)-GEN_SCHEDULE(NUCLEAR_GEN,INTERVAL-1)=l= GENVALUE(NUCLEAR_GEN,"RAMP_RATE")*60*INTERVAL_LENGTH*NUCLEAR_RAMP_UP(NUCLEAR_GEN,INTERVAL)
*- .0001*NUCLEAR_RAMP_DN(NUCLEAR_GEN,INTERVAL)
;

$onText
Both of the Q_CONSECUTIVE_RAMP_DOWN1 and Q_CONSECUTIVE_RAMP_DOWN2 equations are not valid here since they only consist of the parameters whose values are already known.
$offText
...
********************************************************************************
$onText Comment # Don't seem to be useful for now
Q_NUCLEAR_RAMP_STABLE1
Q_NUCLEAR_RAMP_STABLE2
Q_NUCLEAR_RAMP_STABLE3
$offText
* Comment on 01/23/2023: Just leave it for a test demonstration
Q_NUCLEAR_RAMP_STABLE3
*Q_NUCLEAR_RAMP_STABLE4
******************************************01/20/2023*******************************
